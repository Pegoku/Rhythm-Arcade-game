...
// Game mode toggle
bool useRandomMode = true; // Set to true for random mode, false for song mode
...
Note song1[] = {
  {0,    0,  1200},    // Red (slower, longer)
  {1,  600,  1200},    // Green (overlaps, slower)
  {2, 1400,  1000},    // Blue
  {3, 2000,  1000},    // Yellow
  {0, 2600,   900},    // Red
  {1, 3100,   900},    // Green (quick)
  {2, 3600,   900},    // Blue (quick)
  {3, 4100,   900},    // Yellow (quick)
  {0, 4600,   700},    // Red (very quick)
  {1, 4900,   700},    // Green (very quick)
  {2, 5200,  1200},    // Blue (longer)
  {3, 5800,  1200},    // Yellow (longer)
  {1, 6400,   900},    // Green
  {0, 6900,   900},    // Red
  {2, 7400,   900},    // Blue
  {3, 7900,   900},    // Yellow
  {0, 8400,  1000},    // Red (extra, for longer song)
  {1, 9000,  1000},    // Green
  {2, 9600,  1000},    // Blue
  {3,10200,  1000},    // Yellow
  {-1,11200, 1500},    // End marker/pause
};
...
void playRandomMode() {
  ...
  unsigned long timeout = random(150, 300);
