...
Note song1[] = {
  {0,    0,   800},    // Red
  {1,  400,   800},    // Green (overlaps)
  {2,  900,   700},    // Blue
  {3, 1300,   700},    // Yellow
  {0, 1700,   600},    // Red
  {1, 2000,   600},    // Green (quick)
  {2, 2300,   600},    // Blue (quick)
  {3, 2600,   600},    // Yellow (quick)
  {0, 2900,   400},    // Red (very quick)
  {1, 3100,   400},    // Green (very quick)
  {2, 3300,   800},    // Blue (longer)
  {3, 3700,   800},    // Yellow (longer)
  {1, 4100,   600},    // Green
  {0, 4400,   600},    // Red
  {2, 4700,   600},    // Blue
  {3, 5000,   600},    // Yellow
  {-1, 5600, 1000},    // End marker/pause
};
