...
Note song2[] = {
  ...
  {getNoteButton('G'), 500, 500},   // G (quarter note)  
  {getNoteButton('G'), 1000, 250},  // G (eighth note)
  {getNoteButton('D'), 1250, 250},  // D (eighth note)
  ...
  {getNoteButton('D'), 4000, 250},  // D (eighth note)
  {getNoteButton('A'), 4250, 500},  // A (quarter note)
  {getNoteButton('F'), 4750, 500},  // F (quarter note)
  {getNoteButton('F'), 5250, 250},  // F (eighth note)
  {getNoteButton('C'), 5500, 250},  // C (eighth note)
  {getNoteButton('C'), 5750, 250},  // C (eighth note)
  {getNoteButton('E'), 6000, 250},  // E (eighth note)
