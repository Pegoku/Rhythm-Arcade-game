...
Note song2[] = {
  ...
  {getNoteButton('D'), 8000, 500/2},  // D (quarter note)
  {getNoteButton('B'), 8500, 250/2},  // Bb (eighth note)
  {getNoteButton('G'), 8750, 500/2},  // G (quarter note)
  {getNoteButton('G'), 9250, 250/2},  // G (eighth note)
  {getNoteButton('D'), 9500, 250/2},  // D (eighth note)
  {getNoteButton('D'), 9750, 250/2},  // D (eighth note)
  {getNoteButton('A'), 10000, 500/2}, // A (quarter note)
  {getNoteButton('F'), 10500, 500/2}, // F (quarter note)
  {getNoteButton('F'), 11000, 250/2}, // F (eighth note)
  {getNoteButton('D'), 11250, 500/2}, // D (quarter note)
  
  // Measure 4: D A F F C C E E F
  {getNoteButton('D'), 12000, 250/2}, // D (eighth note)
  {getNoteButton('A'), 12250, 500/2}, // A (quarter note)
  {getNoteButton('F'), 12750, 500/2}, // F (quarter note)
  {getNoteButton('F'), 13250, 250/2}, // F (eighth note)
  {getNoteButton('C'), 13500, 250/2}, // C (eighth note)
  {getNoteButton('C'), 13750, 250/2}, // C (eighth note)
  {getNoteButton('E'), 14000, 250/2}, // E (eighth note)
  {getNoteButton('E'), 14250, 250/2}, // E (eighth note)
  {getNoteButton('F'), 14500, 500/2}, // F (quarter note)

  // Measure 5: D Bb G G D D A F F D (half notes)
  {getNoteButton('D'), 16000, 1000/2},// D (half note)
  {getNoteButton('B'), 17000, 250/2}, // Bb (eighth note)
  {getNoteButton('G'), 17500, 1000/2},// G (half note)
  {getNoteButton('G'), 18500, 250/2}, // G (eighth note)
  {getNoteButton('D'), 18750, 250/2}, // D (eighth note)
  {getNoteButton('D'), 19000, 250/2}, // D (eighth note)
  {getNoteButton('A'), 19250, 500/2}, // A (quarter note)
  {getNoteButton('F'), 19750, 1000/2},// F (half note)
  {getNoteButton('F'), 20750, 250/2}, // F (eighth note)
  {getNoteButton('D'), 21000, 500/2}, // D (quarter note)

  // Measure 6: D A F F C C E E F
  {getNoteButton('D'), 22000, 250/2}, // D (eighth note)
  {getNoteButton('A'), 22250, 500/2}, // A (quarter note)
  {getNoteButton('F'), 22750, 1000/2},// F (half note)
  {getNoteButton('F'), 23750, 250/2}, // F (eighth note)
  {getNoteButton('C'), 24000, 500/2}, // C (quarter note)
  {getNoteButton('C'), 24500, 250/2}, // C (eighth note)
  {getNoteButton('E'), 24750, 500/2}, // E (quarter note)
  {getNoteButton('E'), 25250, 250/2}, // E (eighth note)
  {getNoteButton('F'), 25500, 1000/2},// F (half note)
  
  // Measure 7: D Bb G G D D A F F D (final measure)
  {getNoteButton('D'), 27000, 500/2}, // D (quarter note)
  {getNoteButton('B'), 27500, 250/2}, // Bb (eighth note)
  {getNoteButton('G'), 27750, 500/2}, // G (quarter note)
  {getNoteButton('G'), 28250, 250/2}, // G (eighth note)
  {getNoteButton('D'), 28500, 250/2}, // D (eighth note)
  {getNoteButton('D'), 28750, 250/2}, // D (eighth note)
  {getNoteButton('A'), 29000, 500/2}, // A (quarter note)
  {getNoteButton('F'), 29500, 1000/2},// F (half note)
  {getNoteButton('F'), 30500, 250/2}, // F (eighth note)
  {getNoteButton('D'), 30750, 1000/2},// D (half note)

  {-1, 32000, 1000/2}, // End marker
};
