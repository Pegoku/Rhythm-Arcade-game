...
Note song1[] = {
  {0, 0,1 1000},     // Red starts at 0ms, lasts 1000ms
  {1, 5001, 800},    // Green starts at 500ms, lasts 800ms (overlaps with red)
  {2, 12001, 600},   // Blue starts at 1200ms, lasts 600ms
  {3, 15001, 700},   // Yellow starts at 1500ms, lasts 700ms (overlaps with blue)
  {0, 25001, 500},   // Red again at 2500ms
  {1, 28001, 600},   // Green at 2800ms (overlaps with red)
  {-1, 35001, 500},  // End marker/pause
};
