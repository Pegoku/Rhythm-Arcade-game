...
void setup()
{
  ...
  display3.clear();
  display3.setSegments({letterEncoding[characters[0]], letterEncoding[characters[1]], letterEncoding[characters[2]], letterEncoding[characters[3]]}); // Initialize display3 with characters
